...
// 최신댓글 목록 가져와 추가(AJAX)
function getNewMemo() {
	var url = "${_ctx}/main/newmemo.json";
			...
			<div class="rightBlock">
				...
				<div class="main-box">
					...
					<div class="floating-box">
						...
						<thead>
							<tr>
								<th rowspan="2"><p class="title-main">
								<iframe src="http://www.kma.go.kr/weather/main-now-weather.jsp"
										width="524px" height="625px" frameborder="0" marginwidth="0"
										marginheight="0" scrolling="no" title="현재날씨"></iframe></p><hr>
								</th>
