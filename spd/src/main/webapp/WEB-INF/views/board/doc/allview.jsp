...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<c:import url="/WEB-INF/views/inc/left.jsp" />
		    ...
		    <form id="frmSearch" name="frmSearch" class="search_area" action="${_ctx}/board/doc/allview" method="get">
           ...
           <tbody>
           	 ...
           	 <c:forEach items="${list}" var="item" >
		           <tr>
		             <td>${item.mapNm}</td>
		             <td>${item.docId}</td>
		             <td class="txtCut alignLeft" ><a href="${_ctx}/board/doc/view2?docId=${item.docId}">
		             ${item.title}
